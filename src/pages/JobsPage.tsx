...
import { Search, Filter, Briefcase, MapPin, Clock, DollarSign, ChevronRight, Plus, Building, Users, TrendingUp } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-dental-100 mb-8">
                Discover career opportunities in dentistry. Connect with leading dental practices, clinics, and organizations worldwide
              </p>
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">Post a Job</h3>
                <p className="text-dental-100 mb-6">
                  Find the perfect dental professionals for your practice
                </p>
                {user ? (
                  <Link
                    to="/jobs/create"
