...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      {/* Composite Reputation System Explanation Section */}

      <section className="py-24 bg-gradient-to-br from-purple-50 to-purple-100 relative overflow-hidden">
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-purple-200 opacity-30 rounded-full blur-3xl z-0"></div>
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-yellow-100 opacity-30 rounded-full blur-3xl z-0"></div>
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-5xl font-extrabold text-purple-900 mb-4 flex items-center justify-center gap-2 tracking-tight drop-shadow">
              <Star className="inline-block h-10 w-10 text-purple-500 mr-2 animate-pulse" />
              How Reputation Works on DentalReach
            </h2>
            <p className="text-xl text-purple-700 max-w-2xl mx-auto font-medium">
              Reputation is your professional fingerprint on DentalReach. It’s earned by sharing knowledge, helping peers, and being recognized for your expertise and positive impact.
            </p>
          </div>
          <div className="bg-white/90 rounded-3xl shadow-2xl p-10 md:p-16 border-2 border-purple-100 flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 flex flex-col items-center md:items-start">
              <div className="flex items-center gap-3 mb-6">
                <Star className="h-10 w-10 text-yellow-400 animate-spin-slow" />
                <span className="text-3xl font-bold text-purple-800 tracking-tight">Composite Reputation Score</span>
              </div>
              <p className="text-purple-800 mb-6 text-lg md:text-xl font-medium">
                Your score is a blend of your published work, community engagement, peer recognition, and achievements. It’s designed to reward both quality and helpfulness.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mb-4">
                <div className="flex items-center gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100">
                  ...
                  <div>
                    <div className="font-bold text-purple-900">Articles & Publications</div>
                    <div className="text-purple-700 text-sm">Points for every peer-reviewed article, case, or journal you publish</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100">
                  <Users className="h-7 w-7 text-purple-500" />
                  <div>
                    <div className="font-bold text-purple-900">Forum & Community</div>
                    <div className="text-purple-700 text-sm">Points for starting discussions, posting comments, and helping others</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100">
                  <Heart className="h-7 w-7 text-purple-500" />
                  <div>
                    <div className="font-bold text-purple-900">Peer Ratings</div>
                    <div className="text-purple-700 text-sm">Endorsements and ratings from other professionals</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100">
                  <Trophy className="h-7 w-7 text-purple-500" />
                  <div>
                    <div className="font-bold text-purple-900">Awards & Achievements</div>
                    <div className="text-purple-700 text-sm">Special recognitions, leaderboard, and milestone bonuses</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex-1 flex flex-col items-center">
              <div className="bg-gradient-to-br from-yellow-100 to-purple-50 rounded-2xl p-8 shadow-lg w-full max-w-xs border border-purple-100">
                <h3 className="text-xl font-semibold text-purple-900 mb-3 flex items-center gap-2"><Star className="h-6 w-6 text-yellow-400" /> Reputation Formula (Actual)</h3>
                <div className="text-purple-800 text-base mb-3">
                  <span className="font-mono block text-base bg-purple-50 rounded px-3 py-2 mb-2 border border-purple-100">
                    score = (avg_rating × 50) + (article_likes × 2) + (post_likes × 2) + (articles × 1)
                  </span>
                </div>
                <ul className="text-purple-700 text-base space-y-2 mb-2">
                  <li><b>avg_rating</b>: Average of all peer ratings (out of 5 stars). If no ratings, uses 0. Multiplied by 50 (so a perfect 5-star average gives 250 points).</li>
                  <li><b>article_likes</b>: Number of unique likes on your articles. Each like is worth 2 points.</li>
                  <li><b>post_likes</b>: Number of unique likes on your forum posts. Each like is worth 2 points.</li>
                  <li><b>articles</b>: Number of articles you have published. Each article is worth 1 point.</li>
                </ul>
                <div className="text-purple-600 text-xs mt-2">
                  <b>Note:</b> This formula is calculated from real activity and ratings in the system, not just raw counts.
                </div>
              </div>
              <div className="mt-8 text-purple-700 text-center text-base flex flex-col items-center">
                <Lightbulb className="inline-block h-6 w-6 text-purple-400 mb-2 animate-bounce" />
                <span className="font-semibold">Tip:</span>
                <span>
                  The formula is designed to reward both quality and engagement. Everyone can build reputation by contributing, learning, and supporting others!
                </span>
              </div>
            </div>
          </div>
...
<section className="py-16 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-12">
      <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">Meet Our Community Leader</h2>
