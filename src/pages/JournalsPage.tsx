...
const JournalsPage = () => {
  ...
  return (
    <div className="pb-16 font-inter bg-neutral-50 min-h-screen">
      <SidebarTransition open={sidebarOpen} onClose={() => setSidebarOpen(false)} reverse />
      {/* Journals nav button styled and placed full height left side, reverse wipe */}
      <div className="fixed top-0 left-0 h-full z-40 flex flex-col items-center justify-center group">
        <button
        ...
        >
          <div className="flex flex-col items-center justify-center h-full w-full transition-all duration-400">
            <span className="text-lg font-semibold tracking-wide rotate-[-90deg] m-0 p-0">Articles</span>
          </div>
        </button>
      </div>
