                        ...
                        <>
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            {collaborators.map((collaborator) => (
                              <Link
                                key={collaborator.id}
                                to={`/dentists/${collaborator.id}`}
                                className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium hover:bg-blue-200 transition-colors duration-150 border border-blue-200"
                              >
