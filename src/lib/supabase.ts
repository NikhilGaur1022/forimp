...
interface Database {
  public: {
    Tables: {
      ...
      // Added from old file - was missing this table
      seller_applications: {
        Row: {
          id: number;
          user_id: string;
        ...
        Insert: Omit<SellerApplication, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<SellerApplication, 'id' | 'created_at' | 'updated_at'>>;
      }
      notifications: {
        Row: {
          id: number
